...
/**
 * dialog pops up alerting user if item price is not entered or
 * not a number
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB)
public class ItemPriceFragment extends DialogFragment {
    @Override
    /**
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setMessage(R.string.item_price_fragment)
